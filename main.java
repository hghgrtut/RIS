...
public class main {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        System.out.println("\nSum Of Power Of ElectroDevice = " + allPower);

        //создаем 2 потока для сериализации объектов и сохранения их в файл
        FileOutputStream outputStream = new FileOutputStream("E:\\4 КУРС\\lab2_v2_2\\save.ser");
        ...
        FileInputStream fileInputStream = new FileInputStream("E:\\4 КУРС\\lab2_v2_2\\save.ser");
